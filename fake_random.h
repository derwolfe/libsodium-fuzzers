...
static const char* fake_implementation_name(void) { return "fake_random"; }

static void fake_random_buffer(void* const buf, const size_t size) {
...
void setup_fake_random(const unsigned char* seed, const size_t seed_size) {
  SEED_DATA = seed;
  SEED_SIZE = seed_size;
